...
Public Class inventoryReportDoc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SADPOS.inventoryReportDoc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedinventoryReportDoc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As inventoryReportDoc = New inventoryReportDoc()
        rpt.Site = Me.Site
        Return rpt
    End Function
